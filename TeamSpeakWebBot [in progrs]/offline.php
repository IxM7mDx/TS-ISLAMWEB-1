...
<head>
  ...
  <title>لوحة التحكم للتيم سبيك | <?php echo $lang["page_title"]; ?></title>
  ...
  <!-- Page -->
  <link rel="stylesheet" href="templates/pro/assets/css/pages/lockscreen.min.css">
...
<body class="page-locked layout-full page-dark">
  ...
  data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle">
      <p class="locked-user">.لا تستطيع دخول لوحة التحكم وانت خارج سيرفر التيم سبيك‎</p>
      <p>في حال ان كان هناك مشكلة تواصل مع الادارة</p>
