	  ...
	  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
		...
		<div class="navbar-header">
		  ...
		  <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
			<img class="navbar-brand-logo" src="templates/pro/assets/images/logo.png" title="Remark">
		  ...
		  <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
						  ...
						  <ul class="blocks-2">
							...
							<li class="mega-menu margin-0">
							  <ul class="list-icons">
								...
								<li><i class="wb-chevron-right-mini" aria-hidden="true"></i>
								  <a
								  href="templates/pro/structure/overlay.html">Overlay</a>
								</li>
								<li><i class="wb-chevron-right-mini" aria-hidden="true"></i>
								  <a
						  ...
						  <ul class="blocks-3">
							<li>
							  <a class="thumbnail margin-0" href="javascript:void(0)">
								<img class="width-full" src="templates/pro/assets/photos/view-1-150x100.jpg" alt="..."
								/>
							  </a>
							</li>
							<li>
							  <a class="thumbnail margin-0" href="javascript:void(0)">
								<img class="width-full" src="templates/pro/assets/photos/view-2-150x100.jpg" alt="..."
								/>
							  </a>
							</li>
							<li>
							  <a class="thumbnail margin-0" href="javascript:void(0)">
								<img class="width-full" src="templates/pro/assets/photos/view-3-150x100.jpg" alt="..."
								/>
							  </a>
							</li>
							<li>
							  <a class="thumbnail margin-0" href="javascript:void(0)">
								<img class="width-full" src="templates/pro/assets/photos/view-4-150x100.jpg" alt="..."
								/>
							  </a>
							</li>
							<li>
							  <a class="thumbnail margin-0" href="javascript:void(0)">
								<img class="width-full" src="templates/pro/assets/photos/view-5-150x100.jpg" alt="..."
								/>
							  </a>
							</li>
							<li>
							  <a class="thumbnail margin-0" href="javascript:void(0)">
								<img class="width-full" src="templates/pro/assets/photos/view-6-150x100.jpg" alt="..."
								/>
							  </a>
							</li>
						  </ul>
			...
			switch ($lang) {
			  ...
			  $lang_file = 'lang.ar.php';
			   echo '
			<ul class="nav navbar-toolbar navbar-right navbar-toolbar-right" style="float:left;">
			 ';
			  break;
...
<?php
$connectdb = mysql_connect('localhost','root','')or die("Could not connect to the server");
$selectadb = mysql_select_db("king") or die("The database could not be found!");

$req_query = mysql_query("SELECT `from` FROM `frin_req` WHERE `to`='$client_db'") or die(mysql_error());

$namber = "0";
?>
<li class="dropdown">
				<a data-target="#examplePositionCenter" data-toggle="modal" type="button">
				  <i class="icon wb-cloud" aria-hidden="true"></i>
				  <span class="badge badge-danger up" onclick="myFunction()" id="demo">Post</span>
				</a>
</li>
			  <li class="dropdown">
				...
				data-animation="scale-up" role="button">
				  ...
				  <span class="badge badge-danger up" onclick="myFunction()" id="demo">Click</span>
				</a>
...
<?php
while($row1 = mysql_fetch_array($req_query, MYSQL_ASSOC)){
	$from = $row1['from'];
	$from_g = count($from);

	$get_query = mysql_query("SELECT * FROM user WHERE u_db='$from'", $connectdb)or die(mysql_error());
	while($row = mysql_fetch_array($get_query, MYSQL_ASSOC)){
		$us_name = $row['u_name'];
		$sit_idd = $row['u_id'];
		echo '
						<a class="list-group-item" href="profile/'.$from.' role="menuitem">
						  <div class="media">
							<div class="media-body">
							  <h6 class="media-heading">'.$us_name.'    |   <button type="button" href="actions.php?actions=accept&id='.$from.'&to='.$sit_idd.'" class="btn btn-xs btn-success">Accept</button> <button type="button" class="btn btn-xs btn-dark" href="actions.php?actions=accept&id='.$from.'&to='.$sit_idd.'">Ignore</button></h6>
							</div>
						  </div>
						</a>';					
}
...
<script>
function myFunction() {
    document.getElementById("demo").innerHTML = "<?php echo $from_g;?>";
}
</script>
					  </div>
					</div>
			...
			<div>
			  <ul class="site-menu">
				...
				<li class="site-menu-item has-sub">
				  ...
				  <ul class="site-menu-sub">
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/alerts.html" data-slug="structure-alerts">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Alerts</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/ribbon.html" data-slug="structure-ribbon">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Ribbon</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/pricing-tables.html" data-slug="structure-pricing-tables">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Pricing Tables</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/overlay.html" data-slug="structure-overlay">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Overlay</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/cover.html" data-slug="structure-cover">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Cover</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/timeline-simple.html" data-slug="structure-timeline-simple">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Simple Timeline</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/timeline.html" data-slug="structure-timeline">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Timeline</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/step.html" data-slug="structure-step">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Step</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/comments.html" data-slug="structure-comments">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Comments</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/media.html" data-slug="structure-media">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Media</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/chat.html" data-slug="structure-chat">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Chat</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/testimonials.html" data-slug="structure-testimonials">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Testimonials</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/nav.html" data-slug="structure-nav">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Nav</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/navbars.html" data-slug="structure-navbars">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Navbars</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/blockquotes.html" data-slug="structure-blockquotes">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Blockquotes</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/pagination.html" data-slug="structure-pagination">
						<i class="site-menu-icon " aria-hidden="true"></i>
						<span class="site-menu-title">Pagination</span>
					  </a>
					</li>
					<li class="site-menu-item">
					  <a class="animsition-link" href="templates/pro/structure/breadcrumbs.html" data-slug="structure-breadcrumbs">
						<i class="site-menu-icon " aria-hidden="true"></i>
                        ...
                        role="dialog" tabindex="-1">
                          <div class="modal-dialog modal-center">
                            <div class="modal-content">
							  ...
							  $p_from = $client_db;
							  $p_text = $_POST['post'];
							  $p_date = "20".date("y")."/".date("m")."/".date("d")."   ".date("H").":".date("i").":".date("s")."";
							  $adddb = mysql_query("INSERT INTO post (p_from,p_text,p_date) VALUES ('$p_from','$p_text','$p_date')") or die(mysql_error());
							  }
							  } 
							  ?>
